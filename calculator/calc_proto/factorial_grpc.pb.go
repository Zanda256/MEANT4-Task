...
func (c *factorialClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (Factorial_CalculateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Factorial_ServiceDesc.Streams[0], "/calculator.Factorial/Calculate", opts...)
	if err != nil {
		return nil, err
	}
...
var Factorial_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "calculator.Factorial",
	...
	Metadata: "calculator/calc_proto/factorial.proto",
}
